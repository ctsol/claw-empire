                ...
                <>
                  {isConnected ? (
                    ...
                    <span className="text-[11px] px-2.5 py-1 rounded-lg bg-amber-500/20 text-amber-300 font-medium">
                      {t({ ko: "", en: "Detected", ja: "検出済み", zh: "已检测", ru: "Обнаружен" })}
                    </span>
                  ) : null}
                    ...
                    deviceCode && deviceStatus === "polling" ? (
                      ...
                      >
                        {isConnected || isDetectedOnly
                          ? t({ ko: "", en: "Add Account", ja: "アカウント追加", zh: "添加账号", ru: "Добавить аккаунт" })
                          : t({ ko: "", en: "Connect", ja: "接続", zh: "连接", ru: "Подключить" })}
                      </button>
                    )
                  ) : (
                    <button
