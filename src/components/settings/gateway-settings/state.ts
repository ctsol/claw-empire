...
export function defaultWorkflowPackLabel(t: ChannelSettingsTabProps["t"], key: WorkflowPackKey): string {
  switch (key) {
    ...
    case "video_preprod":
      return t({ ko: "", en: "Video Preprod", ja: "映像企画", zh: "视频策划", ru: "Видео Препродакшн" });
    case "web_research_report":
      return t({ ko: "+", en: "Web Research", ja: "Web調查", zh: "网页调研", ru: "Веб-исследование" });
    case "roleplay":
      return t({ ko: "", en: "Roleplay", ja: "ロールプレイ", zh: "角扮演", ru: "Ролевая игра" });
    default:
      return key;
  }
}
