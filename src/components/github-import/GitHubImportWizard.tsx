  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-2 border-b border-slate-700 px-5 py-3">
        ...
        >
          1. {t({ ko: "리포 선택", en: "Select Repo", ja: "リポ選択", zh: "选择仓库", ru: "Выбор репо" })}
        </button>
        ...
        >
          2. {t({ ko: "브랜치", en: "Branch", ja: "ブランチ", zh: "分支", ru: "Ветка" })}
        </button>
        <span className="text-slate-600">/</span>
        <button
          type="button"
        ...
        >
          3. {t({ ko: "가져오기", en: "Import", ja: "インポート", zh: "导入", ru: "Импорт" })}
        </button>
      ...
      <div className="flex-1 overflow-y-auto p-5">
          ...
          <div className="space-y-3">
            <div className="space-y-2 rounded-xl border border-slate-600/50 bg-slate-800/40 p-3">
              ...
              <div className="flex gap-2">
                ...
                >
                  {t({ ko: "이동", en: "Go", ja: "移動", zh: "前往", ru: "Перейти" })}
                </button>
              </div>
                ...
                {repos.map((repo) => (
                  ...
                  >
                    ...
                    <p className="mt-1 text-[11px] text-slate-500">
                      {t({ ko: "기본 브랜치", en: "Default", ja: "デフォルト", zh: "默认分支", ru: "По умолчанию" })}: {repo.default_branch}{" "}
        ...
        {step === "branch" && selectedRepo && (
          <div className="space-y-3">
            ...
            <h4 className="text-xs font-semibold text-slate-300">
              {t({ ko: "브랜치 선택", en: "Select Branch", ja: "ブランチを選択", zh: "选择分支", ru: "Выбрать ветку" })}
            </h4>
            {branchError && (
              <div className="space-y-3">
                ...
                <div className="space-y-2 rounded-xl border border-amber-500/30 bg-amber-900/10 p-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {patLoading
                        ? t({ ko: "확인 중...", en: "Verifying...", ja: "確認中...", zh: "验证中...", ru: "Проверка..." })
                        : t({ ko: "인증", en: "Authenticate", ja: "認証", zh: "认证", ru: "Аутентифицировать" })}
                    </button>
                  </div>
                </div>
              </div>
            ...
            {branchesLoading ? (
              ...
              <p className="text-xs text-slate-500">
                {t({ ko: "브랜치 없음", en: "No branches", ja: "ブランチなし", zh: "无分支", ru: "Нет веток" })}
              </p>
            ) : (
              <div className="space-y-1">
                {branches.map((branch) => (
        ...
        {step === "clone" && selectedRepo && selectedBranch && (
          <div className="space-y-4">
            ...
            <label className="block text-xs text-slate-400">
              {t({ ko: "대상 경로", en: "Target Path", ja: "対象パス", zh: "目标路径", ru: "Целевой путь" })}
              <input
                type="text"
                value={targetPath}
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-slate-400">
                    {cloneStatus === "done"
                      ? t({ ko: "완료", en: "Complete", ja: "完了", zh: "完成", ru: "Завершено" })
                      : t({ ko: "클론 중...", en: "Cloning...", ja: "クローン中...", zh: "正在克隆...", ru: "Клонирование..." })}
                  </span>
            ...
            <div className="flex gap-2">
              ...
              >
                {creating
                  ? t({ ko: "가져오는 중...", en: "Importing...", ja: "インポート中...", zh: "正在导入...", ru: "Импорт..." })
                  : t({
                      ko: "GitHub에서 가져오기",
              ...
              >
                {t({ ko: "이전", en: "Back", ja: "戻る", zh: "返回", ru: "Назад" })}
              </button>
            </div>
          </div>
        )}
