  ...
  const description =
    reason === "not_connected"
      ...
      : t({
          ...
          ru: "Текущий токен GitHub не имеет права repo. Переподключитесь для доступа ко всем репозиториям, включая приватные.",
        });
            ...
            {disconnecting
              ...
              : reason === "not_connected"
                ...
                : t({
                    ...
                    ru: "Переподключить GitHub (права repo)",
                  })}
          </button>
          <button
            type="button"
        ...
        <div className="space-y-3 rounded-xl border border-blue-500/30 bg-blue-900/20 p-4">
          <p className="text-xs text-slate-300">
            {t({
              ...
              ru: "Введите этот код на странице верификации GitHub:",
            })}
          </p>
          ...
          {deviceVerifyUrl && (
            ...
            >
              {t({
                ...
                ja: "GitHub 認証ページを開く",
                zh: "打开 GitHub 验证页面",
                ru: "Открыть страницу верификации GitHub",
              })}
            </a>
          )}
      ...
      {deviceStatus === "complete" && (
        <div className="rounded-lg border border-green-500/20 bg-green-500/10 px-3 py-2 text-xs text-green-400">
          {t({
            ...
            ru: "GitHub подключён! Загрузка репозиториев...",
          })}
        </div>
      )}
