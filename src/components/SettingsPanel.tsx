            ...
            if (result.status === "complete") {
              ...
              setDeviceError(
                result.status === "expired"
                  ? t({ ko: "", en: "Code expired", ja: "コードの期限切れ", zh: "代码已过期", ru: "Код истёк" })
                  : t({
                      ko: "",
              ...
              setDeviceError(
                result.error || t({ ko: "", en: "Unknown error", ja: "不明なエラー", zh: "未知错误", ru: "Неизвестная ошибка" }),
              );
              return;
            }
          } catch {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4 sm:space-y-6">
      <h2 className="text-xl font-bold flex items-center gap-2" style={{ color: "var(--th-text-heading)" }}>
        ⚙️ {t({ ko: "", en: "Settings", ja: "設定", zh: "设置", ru: "Настройки" })}
      </h2>
