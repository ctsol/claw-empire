    ...
    <div className="flex flex-wrap items-center gap-2">
      <div className="relative min-w-[140px] flex-1 sm:min-w-[180px]">
        ...
        <input
          ...
          placeholder={t({ ko: "...", en: "Search tasks...", ja: "タスク検索...", zh: "搜索任务...", ru: "Поиск задач..." })}
      ...
      >
        <option value="">{t({ ko: "", en: "All Departments", ja: "全部署", zh: "全部门", ru: "Все отделы" })}</option>
      ...
      <AgentSelect
        ...
        placeholder={t({ ko: "", en: "All Agents", ja: "全エージェント", zh: "全部代理", ru: "Все агенты" })}
        size="md"
      />
      ...
      <select
        ...
        className="rounded-lg border border-slate-700 bg-slate-800 px-3 py-1.5 text-sm text-slate-300 outline-none transition focus:border-blue-500"
      >
        <option value="">{t({ ko: "", en: "All Types", ja: "全タイプ", zh: "全部类型", ru: "Все типы" })}</option>
      ...
      {projects && projects.length > 0 && (
        <select
          ...
          className="rounded-lg border border-slate-700 bg-slate-800 px-3 py-1.5 text-sm text-slate-300 outline-none transition focus:border-blue-500"
        >
          <option value="">{t({ ko: "", en: "All Projects", ja: "全プロジェクト", zh: "全部项目", ru: "Все проекты" })}</option>
