        ...
        >
          ...
          >
            ...
            <div className="flex justify-end gap-2 border-t border-slate-700 px-4 py-3">
              ...
              >
                {t({ ko: "새로 작성", en: "Start Fresh", ja: "新規作成", zh: "重新填写", ru: "Начать заново" })}
              </button>
              <button
                type="button"
              ...
              >
                {t({ ko: "불러오기", en: "Load", ja: "読み込み", zh: "加载", ru: "Загрузить" })}
              </button>
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div className="flex justify-end gap-2 border-t border-slate-700 px-4 py-3">
              ...
              <button
                ...
                className="rounded-md bg-blue-600 px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-blue-500"
              >
                {t({ ko: "계속", en: "Continue", ja: "続行", zh: "继续", ru: "Продолжить" })}
              </button>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-3 px-4 py-4">
              <div className="rounded-lg border border-slate-700 bg-slate-800/70 px-3 py-2">
                <p className="text-[11px] text-slate-400">
                  {t({ ko: "현재 위치", en: "Current Location", ja: "現在位置", zh: "当前位置", ru: "Текущее местоположение" })}
                </p>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {t({ ko: "상위 폴더", en: "Up", ja: "上位フォルダ", zh: "上级目录", ru: "Вверх" })}
                </button>
                <button
                  type="button"
      ...
      {draftModalOpen && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-between border-b border-slate-700 px-4 py-3">
              <h3 className="text-sm font-semibold text-white">
                {t({ ko: "임시 저장 목록", en: "Temporary Drafts", ja: "一時保存一覧", zh: "临时草稿列表", ru: "Временные черновики" })}
              </h3>
              <button
                type="button"
                onClick={onCloseDraftModal}
            ...
            <div className="flex justify-end border-t border-slate-700 px-4 py-3">
              ...
              >
                {t({ ko: "전체 삭제", en: "Delete All", ja: "すべて削除", zh: "全部删除", ru: "Удалить все" })}
              </button>
            </div>
          </div>
        </div>
