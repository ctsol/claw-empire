...
export default function DecisionInboxModal({
  ...
  const getKindLabel = (kind: DecisionInboxItem["kind"]) => {
    if (kind === "project_review_ready") {
      return t({ ko: "", en: "Project Decision", ja: "プロジェクト判断", zh: "项目决策", ru: "Решение по проекту" });
    }
    if (kind === "task_timeout_resume") {
      return t({ ko: "", en: "Timeout Resume", ja: "中断タスク再開", zh: "超时任务续跑", ru: "Возобновление задачи" });
    }
    ...
    return t({ ko: "", en: "Agent Request", ja: "エージェント要請", zh: "代理请求", ru: "Запрос агента" });
  };
        ...
        <div className="flex items-center justify-between border-b border-slate-700/50 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-white">
              {t({ ko: "", en: "Pending Decisions", ja: "未決の意思決定", zh: "待处理决策", ru: "Ожидающие решения" })}
            </h2>
                ...
                <div key={item.id} className="rounded-xl border border-slate-700/60 bg-slate-800/50 p-3">
                  <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
                    ...
                    {item.agentId ? (
                      ...
                      >
                        {t({ ko: "", en: "Open Chat", ja: "チャットを開く", zh: "打开聊天", ru: "Открыть чат" })}
                      </button>
                    ) : null}
                  </div>
                        ...
                        return (
                          <div className="space-y-2">
                            ...
                            <p className="text-[11px] text-slate-400">
                              {t({
                                ko: `Selected: ${selectedCount} item(s)`,
            ...
            <div className="mt-2 flex items-center justify-end gap-2">
              ...
              >
                {isFollowupSubmitting
                  ? t({ ko: "...", en: "Sending...", ja: "送信中...", zh: "发送中...", ru: "Отправка..." })
                  : t({ ko: "", en: "Submit Request", ja: "要請登録", zh: "提交请求", ru: "Отправить запрос" })}
              </button>
            </div>
          </div>
        ) : null}
